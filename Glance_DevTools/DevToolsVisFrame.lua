...
function cornerVisMethods:OnShow(...)
    ...
    -- if (x > px) then
        -- if (y > py) then
            -- self:SetPoint("BOTTOMLEFT", parent, "BOTTOMLEFT", 20, 120);
        -- else
            -- self:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -120);
        -- end
    -- else
        -- if (y > py) then
            -- self:SetPoint("BOTTOMRIGHT", parent, "BOTTOMRIGHT", -20, 120);
        -- else
            -- self:SetPoint("TOPRIGHT", parent, "TOPRIGHT", -15, -50);
        -- end
    -- end
            self:SetPoint("TOPRIGHT", parent, "TOPRIGHT", -15, -70);
end
